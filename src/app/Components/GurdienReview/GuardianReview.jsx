  ...
  const testimonials = [
    {
      ...
      review:
        "ধন্যবাদ কেয়ারটিউটরস। আমি অনেক দিন ধরে আমার মেয়ের জন্য একজন ভালো শিক্ষক খুঁজছিলাম, কিন্তু কাউকে খুঁজে পাইনি। আমার এক সহকর্মীর মাধ্যমে আমি এই প্ল্যাটফর্মটি খুঁজে পাই। যোগাযোগ করার পর মাত্র দুই দিনের মধ্যে তারা আমাকে একজন ভালো শিক্ষক খুঁজে দিতে সাহায্য করেছে। শিক্ষকটি ভালো পড়াচ্ছেন। আমি আশা করি সবসময় এই প্ল্যাটফর্মের সঙ্গে সংযুক্ত থাকতে পারব। আবারও ধন্যবাদ। কেয়ারটিউটরস-এর অব্যাহত উন্নতির জন্য শুভকামনা।",
    ...
    },
    {
      ...
      review:
        "আমি এই প্ল্যাটফর্মটিকে খুবই নিরাপদ এবং নির্ভরযোগ্য মনে করেছি। আমি ইতোমধ্যে এই প্ল্যাটফর্ম ব্যবহার করে তিনজন শিক্ষক পেয়েছি এবং মনে হচ্ছে তারা আমাদের পরিবারের অংশ হয়ে গেছেন। কেয়ারটিউটরস পরিবারের জন্য শুভকামনা।",
    ...
    },
    {
      ...
      review:
        "কেয়ারটিউটরস-এর সঙ্গে আমার অভিজ্ঞতা সবসময়ই খুব ভালো। এই প্ল্যাটফর্মের মাধ্যমে আমি আমার প্রয়োজন অনুযায়ী ভালো শিক্ষক পেয়েছি। ধন্যবাদ কেয়ারটিউটরস।",
    ...
    },
    {
      ...
      address: "খিলখেত, ঢাকা",
      review:
        "কেয়ারটিউটরস-এর নেওয়া উদ্যোগের প্রশংসা করি। আমি বর্তমানে এই প্ল্যাটফর্মের মাধ্যমে পাওয়া দুইজন শিক্ষকের সঙ্গে যাচ্ছি। তারা উভয়েই যত্নবান এবং আন্তরিক। এছাড়াও, কেয়ারটিউটরস-এর কাছ থেকে জন্মদিনের শুভেচ্ছা পেয়ে আমরা খুবই আনন্দিত হয়েছি। তাদের সফল প্রচেষ্টার জন্য শুভকামনা।",
    ...
    },
    {
      ...
      review:
        "আমি একজন অভিভাবক এবং কেয়ারটিউটরস প্ল্যাটফর্ম ব্যবহার করে আমার ছেলের জন্য একজন শিক্ষক পেয়েছি। তাদের কাছ থেকে চমৎকার সাপোর্ট পেয়েছি। তাদের পুরো টিমকে আমার আন্তরিক ধন্যবাদ।",
    ...
    },
    {
      ...
      review:
        "কেয়ারটিউটরস একটি চমৎকার প্ল্যাটফর্ম; যার মাধ্যমে আমরা আমাদের সন্তানের নির্দিষ্ট চাহিদা অনুযায়ী একজন অভিজ্ঞ শিক্ষক নিরাপদে খুঁজে পেতে পারি। একজন অভিভাবক হিসেবে আমি অত্যন্ত সন্তুষ্ট যে সঠিক সময়ে আমার সন্তানের জন্য একজন দক্ষ শিক্ষক পেয়েছি। আলহামদুলিল্লাহ! ধন্যবাদ কেয়ারটিউটরস।",
    ...
    },
    {
      ...
      review:
        "কেয়ারটিউটরস প্ল্যাটফর্ম ব্যবহার করে মাত্র দুই দিনের মধ্যে আমার মেয়ের জন্য একজন অভিজ্ঞ শিক্ষক নিয়োগ করেছি। তাদের সঙ্গে আমার অভিজ্ঞতা খুবই ভালো। তাদের টিমকে অসংখ্য ধন্যবাদ। ভবিষ্যতেও একই ধরনের সাপোর্ট পাওয়ার আশা করি।",
          ...
          {testimonials.map((item, key) => (
            <CarouselItem key={key} className="items-center justify-center ">
              <div className="lg:flex lg:flex-col justify-center items-center mx-auto gap-4 my-5">
                ...
                <div className="w-full max-w-2xl mx-auto flex lg:pt-6 justify-center clipPath h-auto p-4 pl-8 bg-white rounded-lg shadow-lg">
